...
In addition, by setting `map` to `TRUE`, the function generates air pollutant emission maps by year and specie, using the [rmap](https://github.com/JGCRI/rmap) package documented in the following [page](https://jgcri.github.io/rmap/).
